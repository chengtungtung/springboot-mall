...
class UserControllerTest {
	...
	public void register_success() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(status().is(201)).andExpect(jsonPath("$.userId", notNullValue()))
	...
	public void login_success() throws Exception {
		...
		mockMvc.perform(requestBuilder).andExpect(status().is(200)).andExpect(jsonPath("$.userId", notNullValue()))
